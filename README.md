...
[Roast-2026.08.31.2.dmg](../../releases/download/arm-2026.08.31.2/Roast-2026.08.31.2.dmg)**
— 172 MB. ([release notes](../../releases/tag/arm-2026.08.31.2))
...
already have:
    ...
    /Applications/Roast/
      ...
      CocoaMojo/
        current -> 2026.08.31.2     the version that answers; a symlink
        2026.08.31.2/               a complete, self-contained toolchain:
          bin/
